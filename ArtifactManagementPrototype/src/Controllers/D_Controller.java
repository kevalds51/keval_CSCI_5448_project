...
public class D_Controller {
    ...
    public static void main(String args[]) {
        ...
        // Add a Curator, an Administrator and an Auctioneer
        ...
        System.out.println(collector2.submitBid(myMuseum, 1000, 14200));
        System.out.println(collector1.submitBid(myMuseum, 1000, 14100));

        // Auctioneer hosts the auction and declares the winner
        System.out.println("\nThe Auctioneer is: "+anAuction.getAuctioneer().getName());
        System.out.println(anAuction.getAuctioneer().hostAuction(anAuction, myMuseum));

        // The admin will process the transactions and then move the artifacts
        System.out.println(admin.processRequests(myMuseum));

        // The Collector has received the artifact that he won in the auction.
